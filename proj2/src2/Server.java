...
public class Server {
    ...
    protected static Player.PlayerDatabase playerDatabase = new DatabaseManager();
    ...
    public static void main(String[] args) {
        if (args.length < 4) {
            ...
            System.out.println("Simple Mode Usage: java Server <port> 1 <number of players>");
            System.out.println("Rank Mode Usage: java Server <port> 2 <number of players>");
            System.exit(1);
        }
